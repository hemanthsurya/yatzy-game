...
Opportunity to test out Yatzy!
During the lab session Thursday 5/9, there will opportunity to play Yatzy in H320. This opportunity is provided to give those students interested a session to learn and understand the rule set of Yatzy!. It is strongly recommended to use this session to get an understanding of the game and how it can be divided into sub tasks that can later be used when you sit down to program the assignment. Students that wish to test Yatzy! will be divided into groups and play together. Take this opportunity to discuss and help each other understand the problem space.

For those wishing to use the lab session for programming, H321 will be open for the ordinary labs.
